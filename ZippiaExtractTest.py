...
def companyNameExtractor(url):
    ...
    which allows users to access the demographic interface for each company. If you want to use this scraper for industries other than finance, such as education, manufacturing, media, etc., you will need to modify the code to extract links for those industries. Additionally, you may need to develop your own filtering methods to select the specific companies you are interested in.
    """
...
def saveAll(compNameList, fileName):
    ...
    with open(fileName, mode="w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerow(["Company", "Industry", "Employees Who Are Women", "Executives Who Are Women"])
...
compList = companyNameExtractor("https://www.zippia.com/company/automotive")
Top50 = list(compList)[:50]
#Next50 = list(compList)[50:100]
saveAll(Top50, "demographics2.csv")
#saveAll(Next50, "demographics2.csv")
# print(compNameList)
